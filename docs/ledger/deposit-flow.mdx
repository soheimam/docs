...
<CardGroup cols={2}>
  <Card title="How it works" icon="arrow-left" href="/ledger/how-it-works">
  Review the full payment lifecycle on a Base Ledger.
  </Card>
  <Card title="Withdraw flow" icon="arrow-right" href="/ledger/withdraw-flow">
  See how funds move from a ledger back to Base.
  </Card>
</CardGroup>