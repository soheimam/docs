...
<Warning>
**Early access.** Some features described in this documentation are not yet generally available. [Request a demo](https://www.coinbase.com/developer-platform/developer-interest) to learn more.
</Warning>

## What is a Base Ledger

Base Ledgers let enterprises launch their own private payments products on Base. A Base Ledger is a
private payment ledger connected to Base, where balances, transactions, and transfers remain off
...
withdrawal. Balances settle on Base itself rather than on a separate chain, and a ledger stays agnostic
to the offchain system behind it, so you operate your own sovereign ledger with the customizations you
need.
