...
<Frame>
![Transaction lifecycle swimlane: deposit, hold and transact in private, then withdraw, across User / SDK, Ledger, and the Portal contract on Base.](/images/ledger/how_it_works.png)
</Frame>
...
1. **Deposit.** A user moves funds from Base into the ledger through the Portal contract. The recipient
   remains encrypted, so deposits to one user remain unlinked. See [Deposits](/ledger/deposit-flow).
...
<CardGroup cols={2}>
  <Card title="Overview" icon="arrow-left" href="/ledger/overview">
  Back to the Base Ledgers overview.
  </Card>
  <Card title="Deposit flow" icon="arrow-right" href="/ledger/deposit-flow">
  See how funds move from Base into a ledger.
  </Card>
</CardGroup>
